      ...
      <div className="min-h-screen  flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your tuition request has been submitted and is pending admin
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6">
            ...
            <p className="text-purple-300">All fields are required</p>
          </div>
              ...
              <div>
                ...
                <input
                  ...
                  {...register("location", {
                    ...
                    validate: (value) =>
                      value.trim() !== "" || "Location cannot be empty",
                  })}
              ...
              <div>
                ...
                <input
                  ...
                  {...register("budget", {
                    ...
                    validate: (value) =>
                      !isNaN(value) || "Please enter a valid budget",
                  })}
              ...
              <div>
                ...
                <select
                  {...register("tutorGender", {
                    required: "Tutor gender preference is required",
                  })}
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition ${

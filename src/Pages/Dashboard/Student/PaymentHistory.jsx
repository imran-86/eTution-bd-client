...
import { Eye, DollarSign, CreditCard, CheckCircle, Calendar, Hash, X } from 'lucide-react';
...
export default function PaymentHistory() {
  ...
  const { data: payments = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosInstance.get(`/payments/student/${user?.email}`);
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-4xl font-bold text-indigo-600">{payments.length}</p>
              </div>
        ...
        {payments.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">No Payment History</h3>
              ...
              <table className="w-full">
                <thead className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-sm font-semibold">Tuition</th>
                    ...
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-mono text-sm text-gray-700">{payment.trackingId}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="font-medium text-gray-900">{payment.tuitionName}</span>
                      </td>
                      <td className="px-6 py-4">
            ...
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl p-6 text-center">
                  ...
                  <p className="text-5xl font-bold text-green-600">৳{selectedPayment.amount}</p>
                  <p className="text-gray-500 text-sm mt-2">{selectedPayment.currency.toUpperCase()}</p>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center bg-gray-50 rounded-lg p-4">
                      ...
                      <span className="font-mono font-semibold text-gray-900">{selectedPayment.trackingId}</span>
                    </div>

                    <div className="flex justify-between items-center bg-gray-50 rounded-lg p-4">
                      <span className="text-gray-600">Transaction ID</span>
                      <span className="font-mono text-sm text-gray-900">{selectedPayment.transactionId}</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center bg-gray-50 rounded-lg p-4">
                      ...
                      <span className={`px-3 py-1 rounded-full text-sm font-semibold ${
                        ...
                        {selectedPayment.paymentStatus === 'paid' ? 'Paid' : selectedPayment.paymentStatus}
                      </span>
                    </div>
                ...
                {/* Tuition Information */}
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-3">Tuition Information</h3>
                  <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Tuition Name</span>
                      <span className="font-semibold text-gray-900">{selectedPayment.tuitionName}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-gray-900">{selectedPayment.studentEmail}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-center pt-4 border-t border-gray-200">
                  <p className="text-sm text-gray-500">
                    For any payment related queries, please contact support with your tracking ID
                  </p>
                </div>
              </div>
            </div>
